...
def test():
  ...
  blake2b = sob.get_string_from_bytes(sp.sha256(sp.pack('tz1UZZnrre9H7KzAufFVm7ubuJh5cCfjGwam')))
  scene.verify(blake2b == 'B37B52F6D234BFA87D14BE9A4068805BE283F7A4BAD853CDE67A0699204F7E44') 
  sha512 = sob.get_string_from_bytes(sp.sha512(sp.pack('tz1UZZnrre9H7KzAufFVm7ubuJh5cCfjGwam')))
  ...
  sha256 = sob.get_string_from_bytes(sp.sha256(sp.pack('KT1BfKnSKV6Wx45Cv4yjEYXViwuhmswby8Hp')))
  scene.verify(sha256 == '24EA663496C05A050B5E2151B13602412CB832F6C7B5CE819BE98E54D6FCE8C5') 
  sha3 = sob.get_string_from_bytes(sp.sha3(sp.pack('KT1BfKnSKV6Wx45Cv4yjEYXViwuhmswby8Hp')))
  scene.verify(sha3 == 'EEE1759307F4F814CC9BCF8BD7A06CCC32999546151D3DCCFBD36BB145D50BF1') 
  keccak = sob.get_string_from_bytes(sp.keccak(sp.pack('KT1BfKnSKV6Wx45Cv4yjEYXViwuhmswby8Hp')))
  scene.verify(keccak == '304A54AAE33305631DA4C9DE5DD9E10D15518010CA006C65855315881F564995')
  timestamp = sob.get_string_from_bytes(sp.pack(sp.timestamp(1637752889)))
  scene.verify(timestamp == '0500B980F1990C')
  randomstring = sob.get_string_from_bytes(sp.pack('applecake'))
